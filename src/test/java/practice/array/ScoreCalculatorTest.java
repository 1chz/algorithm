 ...
 */
@DisplayName("배열 - 점수 계산")
public class ScoreCalculatorTest {

    private ScoreCalculator solve = new ScoreCalculator();

    @MethodSource
    @ParameterizedTest
    void solution(final String testCase, final int expected) throws Exception {
    ...
    private static Stream<Arguments> solution() {
        return Stream.of(
            ...
            Arguments.of("1 1 1 1 1 0 0 1 1 0", 18)
        );
    }
